                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <img src= "/public/{{$product->thumbnail_url}}"  width="100px" height="100px" alt="">
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            ...
                                            <img src="/public/{{$product->demo_url}}" width="100px" height="100px" alt="">
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            ...
                                            <a href="{{route('admin.product.download.source',$product->id)}}" class="btn btn-default btn-icons" title="لینک دانلود">دانلود تصویر اصلی
                                                     </a>
                                        </div>
